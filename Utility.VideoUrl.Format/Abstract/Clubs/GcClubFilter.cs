...
///     館別分類
/// </summary>
public class GcClubFilter : BaseClubFilter
{
    private readonly GcVideoFactory factory;
    ...
    public GcClubFilter( ServerContext  db
                      , IMemoryCache   cache
                      , GcVideoFactory factory)  : base(db, cache)
    {
